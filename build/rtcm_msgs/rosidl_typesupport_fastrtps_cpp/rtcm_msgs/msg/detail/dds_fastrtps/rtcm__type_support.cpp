...
#include "rtcm_msgs/msg/detail/rtcm__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rtcm_msgs::msg::Rtcm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcm_msgs::msg::Rtcm *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Rtcm(full_bounded, 0);
}
...
{
  return &rtcm_msgs::msg::typesupport_fastrtps_cpp::_Rtcm__handle;
}
