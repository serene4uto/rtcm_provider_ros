...
#include "rtcm_msgs/msg/detail/rtcm__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // rtcm_data
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // rtcm_data
...
using _Rtcm__ros_msg_type = rtcm_msgs__msg__Rtcm;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: rtcm_data
  {
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->rtcm_data, size)) {
      fprintf(stderr, "failed to create array for field 'rtcm_data'");
      return false;
    }
    auto array_ptr = ros_message->rtcm_data.data;
...
size_t get_serialized_size_rtcm_msgs__msg__Rtcm(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rtcm__ros_msg_type * ros_message = static_cast<const _Rtcm__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Rtcm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcm_msgs__msg__Rtcm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtcm_msgs
size_t max_serialized_size_rtcm_msgs__msg__Rtcm(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtcm_msgs__msg__Rtcm(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtcm_msgs, msg, Rtcm)() {
